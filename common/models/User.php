...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['status', 'in', 'range' => [self::STATUS_ADMIN, self::STATUS_ACTIVE, self::STATUS_INACTIVE, self::STATUS_DELETED, self::STATUS_BANNED]],
    ...
    {
        return $this->hasMany(Challenge::class, ['id' => 'challenge_id'])->viaTable('solve', ['user_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Image::class, ['author_name' => 'username']);
    }
    ...
    {
        return $this->hasMany(Image::class, ['author_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Solve::class, ['user_id' => 'id']);
    }
