...
class TaskSpecPlacement implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'constraints' => 'string[]',
'preferences' => '\Docker\Client\Model\TaskSpecPlacementPreferences[]',
'max_replicas' => 'int',
'platforms' => '\Docker\Client\Model\Platform[]'    ];
...
'platforms' => 'getPlatforms'    ];
     ...
     * Gets preferences
     *
     * @return \Docker\Client\Model\TaskSpecPlacementPreferences[]
     */
     ...
     * Sets preferences
     *
     * @param \Docker\Client\Model\TaskSpecPlacementPreferences[] $preferences Preferences provide a way to make the scheduler aware of factors such as topology. They are provided in order from highest to lowest precedence.
     *
     * @return $this
     */
     ...
     * Gets platforms
     *
     * @return \Docker\Client\Model\Platform[]
     */
     ...
     * Sets platforms
     *
     * @param \Docker\Client\Model\Platform[] $platforms Platforms stores all the platforms that the service's image can run on. This field is used in the platform filter for scheduling. If empty, then the platform filter is off, meaning there are no scheduling restrictions.
     *
     * @return $this
     */
