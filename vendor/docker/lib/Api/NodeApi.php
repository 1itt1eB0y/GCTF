...
class NodeApi
{
     ...
     * @throws \Docker\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\Client\Model\Node
     */
     ...
     * @throws \Docker\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\Client\Model\Node, HTTP status code, HTTP response headers (array of strings)
     */
    public function nodeInspectWithHttpInfo($id)
    {
        $returnType = '\Docker\Client\Model\Node';
     ...
     * @param  \Docker\Client\Model\NodeSpec $body body (optional)
     *
     * @throws \Docker\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  int $version The version number of the node object being updated. This is required to avoid conflicting writes. (required)
     * @param  string $id The ID of the node (required)
     * @param  \Docker\Client\Model\NodeSpec $body (optional)
     *
     * @throws \Docker\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function nodeUpdateRequest($version, $id, $body = null)
    {
